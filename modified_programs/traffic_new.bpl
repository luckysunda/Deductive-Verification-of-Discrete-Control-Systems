...
function {:existential true} {:inline} Invariant (y1:int,y2:int,oy1:int,oy2:int,STATE:int,OLDSTATE:int):bool; 

procedure trafficlightinit()
ensures ((STATE==10 && STATE==20)==> y2==1);
ensures Invariant(y1,y2,oy1,oy2,STATE,OLDSTATE);
...
requires Invariant(y1,y2,oy1,oy2,STATE,OLDSTATE);
ensures Invariant(y1,y2,oy1,oy2,STATE,OLDSTATE);
{
